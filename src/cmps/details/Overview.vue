    ...
    <div class="info-img flex align-center">
      ...
      <div class="seller-preview flex">
        <div class="text">
          ...
          <p class="level">Level {{ gig.owner.level || 5 }} Seller</p>
        </div>
        ...
        <section class="review-preview">
          <section class="grid">
            ...
            <section class="preview-content">
              <p class="content">
                Thank you SO MUCH to the seller. He was so patient and willing
                to work and correct as many times as we needed as some things
                got miscommunicated and he easily fixed them. Thank you!!!
              </p>
